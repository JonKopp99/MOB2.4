...
class GreetingViewController : UIViewController {
    ...
    private func _layoutButton() {
        ...
        let cs1 = NSLayoutConstraint(item: self.showGreetingButton ?? 0, attribute: .centerX, relatedBy: .equal, toItem: self.view, attribute: .centerX, multiplier: 1.0, constant: 1.0)
        let cs2 = NSLayoutConstraint(item: self.showGreetingButton ?? 0, attribute: .centerY, relatedBy: .equal, toItem: self.view, attribute: .centerY, multiplier: 1.0, constant: 1.0)
    ...
    private func _layoutLabel() {
        ...
        let cs1 = NSLayoutConstraint(item: self.greetingLabel ?? 0, attribute: .centerX, relatedBy: .equal, toItem: self.view, attribute: .centerX, multiplier: 1.0, constant: 1.0)
        let cs2 = NSLayoutConstraint(item: self.greetingLabel ?? 0, attribute: .bottom, relatedBy: .equal, toItem: self.view, attribute: .bottom, multiplier: 1.0, constant: -10)
        let cs3 = NSLayoutConstraint(item: self.greetingLabel ?? 0, attribute: .width, relatedBy: .equal, toItem: self.view, attribute: .width, multiplier: 0.70, constant: 0)
...
// Assembling of MVVM
let model = Person(firstName: "Swole", lastName: "Jon")
